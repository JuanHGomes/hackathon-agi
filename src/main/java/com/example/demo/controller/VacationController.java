...
public class VacationController {
    ...
    public List<VacationHistoryResponse> historicoVacation(@PathVariable UUID userId){
       return vacationService.historicoVacation(userId).stream().map(VacationMapper::toResponse).toList();
    }
}